import cylinder
import simvis.network.utilities.tuning.orientation as orientation
import numpy as np
import random
import time

from simvis.network.network import Network
#from simvis.network.connect import ConnectionIterator
import simvis.network.utilities.utilities as nutil
...
Scnn1a = network.create_nodes(type_name='Scnn1a', N=5)
Rorb = network.create_nodes(type_name='Rorb', N=5)
Nr5a1 = network.create_nodes(type_name='Nr5a1', N=5)
PV1 = network.create_nodes(type_name='PV1', N=2)
PV2 = network.create_nodes(type_name='PV2', N=3)
LIF_exc = network.create_nodes(type_name='LIF_exc', N=80)
LIF_inh = network.create_nodes(type_name='LIF_inh', N=20)
...
#print 'radius_biophys = ', radius_biophys
...
network.update_nodes(array_data={ 'morphology': ['cell_models/395830185/Scnn1a-Tg3-Cre_Ai14_IVSCC_-177300.01.02.01_473845048_m.swc'] * len(Scnn1a), 'cell_par': ['cell_models/395830185/472363762_fit.json'] * len(Scnn1a), 'position': positions }, gids=Scnn1a)
...
network.update_nodes(array_data={ 'morphology': ['cell_models/314804042/Rorb-IRES2-Cre-D_Ai14_IVSCC_-168053.05.01.01_325404214_m.swc'] * len(Rorb), 'cell_par': ['cell_models/314804042/473863510_fit.json'] * len(Rorb), 'position': positions }, gids=Rorb)
...
network.update_nodes(array_data={ 'morphology': ['cell_models/318808427/Nr5a1-Cre_Ai14_IVSCC_-169250.03.02.01_471087815_m.swc']*len(Nr5a1), 'cell_par': ['cell_models/318808427/473863035_fit.json']*len(Nr5a1), 'position': positions }, gids=Nr5a1)
...
network.update_nodes(array_data={ 'morphology': ['cell_models/330080937/Pvalb-IRES-Cre_Ai14_IVSCC_-176847.04.02.01_470522102_m.swc']*len(PV1), 'cell_par': ['cell_models/330080937/472912177_fit.json']*len(PV1), 'position': positions }, gids=PV1)
...
network.update_nodes(array_data={ 'morphology': ['cell_models/318331342/Pvalb-IRES-Cre_Ai14_IVSCC_-169125.03.01.01_469628681_m.swc']*len(PV2), 'cell_par': ['cell_models/318331342/473862421_fit.json']*len(PV2), 'position': positions }, gids=PV2)
...
# Write output using the old-style *.dat files.
