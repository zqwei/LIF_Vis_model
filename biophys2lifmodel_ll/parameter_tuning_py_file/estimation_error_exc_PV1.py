...
# Scn_cell_range = [0, 3700]
# Rob_cell_range = [3700, 7000]
# Nra_cell_range = [7000, 8500]
PV1_cell_range = [8500, 9300]
# PV2_cell_range = [9300, 10000]
# cell_range = [Nra_cell_range, PV2_cell_range]
cell_range = [PV1_cell_range]
