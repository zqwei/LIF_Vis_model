...
for syn_data_file in glob('syn_data_*.json'):
    ...
    #         vis_stim_path = 'LGN_spike_trains/output2/spont_LGN_spk.dat'
    #         vis_t_shift = 0.0
    ...
    for grating_id in [8]:  # xrange(8, 240, 30):  # [8]: #xrange(8, 240, 30):     #grating_id = 8
        for trial in [8]:  # xrange(0, 10):  # [8]: #xrange(2, 10): #[8]: #xrange(0, 10):
