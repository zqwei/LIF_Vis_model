...
for trial in [8]: #[0, 3, 4, 6, 8]:
    # print 'Trial %d' % (trial)
    tw_id = 510 + trial
    #fig, axes = plot_functions.plot_spikes_tw('../output_ll2_TouchOfEvil_frames_3600_to_3750_%d_sd278/spk.dat' % (trial), '../tw_data/ll2_tw_build/2_tw_src/f_rates_%d.pkl' % (tw_id), tw_src_id, cells_file='../build/ll2.csv', tstop=5000.0)
    fig, axes = plot_functions.plot_spikes_tw('../simulation_ll2/output_ll2_TouchOfEvil_frames_3600_to_3750_%d_sdlif_z101/spk.dat' % (trial),
    ...
    plt.show()
    plt.savefig('movies/ll2_ToE_8.png')
