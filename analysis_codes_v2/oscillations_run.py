...
sys_dict['LIF_IntFire4_ll1'] = { 'cells_file': '../build/ll1.csv', 'f_1': '/data/mat/ZiqiangW/bio2lif_model_intFire4/output_ll1_', 'f_2': '_sdlif_z101/spk.dat', 'f_out_prefix': 'oscillations/LIF_IntFire4_ll1_spectrum', 'grating_ids': [range(7, 240, 30), range(8, 240, 30), range(9, 240, 30)], 'marker': '--' }
sys_dict['LIF_IntFire4_ll2'] = { 'cells_file': '../build/ll2.csv', 'f_1': '/data/mat/ZiqiangW/bio2lif_model_intFire4/output_ll2_', 'f_2': '_sdlif_z101/spk.dat', 'f_out_prefix': 'oscillations/LIF_IntFire4_ll2_spectrum', 'grating_ids': [range(7, 240, 30), range(8, 240, 30), range(9, 240, 30)], 'marker': '-' }
sys_dict['LIF_IntFire4_ll3'] = { 'cells_file': '../build/ll3.csv', 'f_1': '/data/mat/ZiqiangW/bio2lif_model_intFire4/output_ll3_', 'f_2': '_sdlif_z101/spk.dat', 'f_out_prefix': 'oscillations/LIF_IntFire4_ll3_spectrum', 'grating_ids': [range(7, 240, 30), range(8, 240, 30), range(9, 240, 30)], 'marker': ':' }
