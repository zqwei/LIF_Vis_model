...
sys_dict = {}
sys_dict['ll1'] = { 'cells_file': '../build/ll1.csv', 'f_1': '../simulations_ll1/spont/output_ll1_spont_', 'f_2': '_sd278/spk.dat', 'f_3': '_sd278/tot_f_rate.dat', 'f_out': 'spont_activity/ll1_spont.pkl', 'types': [] }
sys_dict['ll2'] = { 'cells_file': '../build/ll2.csv', 'f_1': '../simulations_ll2/spont/output_ll2_spont_', 'f_2': '_sd278/spk.dat', 'f_3': '_sd278/tot_f_rate.dat', 'f_out': 'spont_activity/ll2_spont.pkl', 'types': [] }
sys_dict['ll3'] = { 'cells_file': '../build/ll3.csv', 'f_1': '../simulations_ll3/spont/output_ll3_spont_', 'f_2': '_sd278/spk.dat', 'f_3': '_sd278/tot_f_rate.dat', 'f_out': 'spont_activity/ll3_spont.pkl', 'types': [] }
...
#sys_dict['ll1_LIF'] = { 'cells_file': '../build/ll1.csv', 'f_1': '/data/mat/ZiqiangW/simulation_ll_syn_data_lif_z102/simulation_ll1/output_ll1_spont_', 'f_2': '_sdlif_z101/spk.dat', 'f_3': '_sdlif_z101/tot_f_rate.dat', 'f_out': 'spont_activity_LIF/ll1_spont.pkl', 'types': [] }
#sys_dict['ll2_LIF'] = { 'cells_file': '../build/ll2.csv', 'f_1': '/data/mat/ZiqiangW/simulation_ll_syn_data_lif_z102/simulation_ll2/output_ll2_spont_', 'f_2': '_sdlif_z101/spk.dat', 'f_3': '_sdlif_z101/tot_f_rate.dat', 'f_out': 'spont_activity_LIF/ll2_spont.pkl', 'types': [] }
#sys_dict['ll3_LIF'] = { 'cells_file': '../build/ll3.csv', 'f_1': '/data/mat/ZiqiangW/simulation_ll_syn_data_lif_z102/simulation_ll3/output_ll3_spont_', 'f_2': '_sdlif_z101/spk.dat', 'f_3': '_sdlif_z101/tot_f_rate.dat', 'f_out': 'spont_activity_LIF/ll3_spont.pkl', 'types': [] }

result_fname_prefix = 'spont_activity/av_spont_rates_by_type'
#result_fname_prefix = 'spont_activity_LIF/av_spont_rates_by_type'
...
# Compute averages, standard deviations, and SEM by type and save to file.
result_f = open(result_fname, 'w')
result_f.write('system cell_type av_rate std sem\n')
...
for sys_name in sys_dict.keys():
    ...
    for type in sys_dict[sys_name]['types']:
        result_string = '%s %s %f %f %f' % (sys_name, type, rates_data['mean'][type][ind].mean(), rates_data['mean'][type][ind].std(), scp_stats.sem(rates_data['mean'][type][ind]))
...
for i_exp, exp_f in enumerate(exp_f_list):
    ...
    exp_data_sem.append(scp_stats.sem(tmp_df['Spont']))
...
ax = df_rates_tmp.pivot(index='cell_type', columns='system', values='av_rate').reindex(['Scnn1a', 'Rorb', 'Nr5a1', 'PV1', 'PV2']).plot(kind='bar', yerr=df_rates_tmp.pivot(index='cell_type', columns='system', values='sem').reindex(['Scnn1a', 'Rorb', 'Nr5a1', 'PV1', 'PV2']), fontsize=20)
