...
for trial in [9]:
    print 'Trial %d' % (trial)
    tw_id = 350 + trial
    fig, axes = plot_functions.plot_spikes_tw('../output_ll2_flash_2_%d_sd278/spk.dat' % (trial), '../tw_data/ll2_tw_build/2_tw_src/f_rates_%d.pkl' % (tw_id), tw_src_id, cells_file='../build/ll2.csv', tstop=1500.0)
