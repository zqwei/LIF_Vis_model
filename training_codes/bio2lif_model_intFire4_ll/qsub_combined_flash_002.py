...
tstop = 1500.0
tw_trial_id = 350
for stim_name in ['flash_2']:
    for trial in xrange(0, 10):
        jobname = '%s_%s_%d_sd%s' % (system_name, stim_name, trial, syn_data_id)
        vis_stim_path = '/allen/aibs/mat/antona/network/14-simulations/6-LGN_firing_rates_and_spikes/LGN_spike_trains/output3/%s_LGN_spk.dat' % (stim_name)
        vis_t_shift = 0.0
