...
vis_map = '/allen/aibs/mat/antona/network/14-simulations/9-network/build/ll2_inputs_from_LGN.csv'
tw_map = '/allen/aibs/mat/antona/network/14-simulations/9-network/tw_data/ll2_tw_build/mapping_2_tw_src.csv'
...
tstop = 5000.0
tw_trial_id = 510
for stim_name in ['TouchOfEvil_frames_3600_to_3750_scrbl_t', 'TouchOfEvil_frames_3600_to_3750_scrbl_xy']:
    for trial in xrange(0, 10):
        ...
        tw_stim_path = '/allen/aibs/mat/antona/network/14-simulations/9-network/tw_data/%s_tw_build/2_tw_src/%d_spk.dat' % (system_name, tw_trial_id)
        tw_t_shift = 0.0
        tw_trials_in_file = 1
