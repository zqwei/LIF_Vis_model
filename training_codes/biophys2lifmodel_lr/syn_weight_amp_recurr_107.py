...
def syn_weight_amp(output_folder, syn_file=''):
    with open('syn_data_lif_z101.jsonbak') as data_file:
        ...
        data["Scnn1a"]["exc"]["w"] = 0.6 * data["Scnn1a"]["exc"]["w"]
        data["Rorb"]["exc"]["w"] = 0.75 * data["Rorb"]["exc"]["w"]
        data["Nr5a1"]["exc"]["w"] = 0.95 * data["Nr5a1"]["exc"]["w"]
        data["PV1"]["exc"]["w"] = 0.7 * data["PV1"]["exc"]["w"]
        data["PV2"]["exc"]["w"] = 0.7 * data["PV2"]["exc"]["w"]
